...
#
#
# modified by kat @ girlonthemoon.xyz for personal use
#
#
#
...
MY_TITLE=$(gum input --placeholder "title of document and header")
...
MY_CSS="https://stash.4-walls.net/gallery/assets/md2html.css"
...
EOF
	...
	# Pager
	echo '<div class="navigation-btns">' >> "$MY_IMAGE_HTML_FILE"
	if [[ $MY_PREV ]]; then
...
<footer class="footer-gallery">
	<span>$MY_FOOTER - $MY_DATETIME</span>
</footer>
</body>
</html>
EOF
